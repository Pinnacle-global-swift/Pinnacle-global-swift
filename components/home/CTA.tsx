      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          >
            ...
            <p className="text-xl mb-8">Join thousands of satisfied customers and take control of your finances today with Pinnacle Global Bank.</p>
          ...
          >
            <div className="relative w-full h-[600px]">
              ...
              <div className="absolute bottom-8 left-8 right-8 text-white">
                ...
                <p className="text-lg">Download our mobile app and manage your finances anytime, anywhere.</p>
              </div>
            </div>
          </motion.div>
        </div>
