...
export default function LoanPage() {
  ...
  const calculateMonthlyPayment = (amount: number, months: number) => {
    ...
    const payment = (amount * interestRate * Math.pow(1 + interestRate, months)) / 
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800">
          <CardHeader className="border-b border-gray-700 pb-7">
            <div className="flex items-center gap-4">
              ...
              <div>
                <CardTitle className="text-2xl text-white">Apply for a Loan</CardTitle>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-200">Loan Amount</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-200">Loan Duration</FormLabel>
                      <Select 
                        onValueChange={(value) => {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-200">Loan Purpose</FormLabel>
                      <FormControl>
                        <Input
                ...
                {monthlyPayment && (
                  <div className="p-4 bg-purple-500/10 rounded-lg flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-white">Estimated Monthly Payment</p>
