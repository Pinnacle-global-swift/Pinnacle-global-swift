            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-primary/10 rounded-lg">
                  ...
                  <div>
                    <h3 className="font-medium">Ready to enhance your banking experience?</h3>
              ...
              <CardFooter>
                <Button onClick={() => setStep('requirements')} className="w-full">
                  Start Application
            ...
            {cardTypes.map((card, index) => (
              ...
              >
                <Card className="h-full">
                  <CardHeader>
                    <div className={`w-full h-40 rounded-lg bg-gradient-to-br ${card.color} p-6 text-white`}>
                      <div className="flex justify-between items-start">
                        <div className="space-y-2">
                          <p className="text-sm opacity-80">FINEbank.IO</p>
