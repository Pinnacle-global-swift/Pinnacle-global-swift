      ...
      >
        <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-200">Nationality</FormLabel>
          ...
          <CardFooter className="border-t border-gray-700 mt-6 flex flex-col items-start pt-6">
            <h4 className="text-sm font-medium text-gray-200 mb-2">Verification Process</h4>
            <p className="text-sm text-gray-400">
              Your documents will be reviewed within 24-48 hours. You will be notified via email
